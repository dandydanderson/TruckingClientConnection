...
const routes: Routes = [
  ...
  {path: 'carrier-info', component: CarrierInfoComponent,canActivate: [AuthGuard]},
  ...
  {path: 'freight-dashboard', component: FreightDashboardComponent,canActivate: [AuthGuard]},
